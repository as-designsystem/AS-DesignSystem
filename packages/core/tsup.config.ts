...
export default defineConfig({
  ...
  onSuccess: () => {
    ...
    const componentCssFiles = ['Icon.css', 'Button.css', 'ButtonGroup.css', 'IconButton.css', 'Tab.css', 'ToolIcons.css', 'Select.css', 'VSelect.css', 'Checkbox.css', 'VCheckbox.css', 'Toggle.css', 'VToggle.css'];
