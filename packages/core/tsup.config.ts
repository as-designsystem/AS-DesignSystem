...
export default defineConfig({
  ...
  onSuccess: () => {
    ...
    const compositeCssFiles = ['Modal.css', 'AppHeader.css', 'ProductBanner.css', 'HomePageActionBar.css', 'PanelHeader.css', 'LeftPanel.css', 'StudyStatusBar.css', 'Accordion.css', 'Workspace.css'];
