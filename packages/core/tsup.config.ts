...
export default defineConfig({
  ...
  onSuccess: () => {
    ...
    const componentCssFiles = ['Alert.css', 'Icon.css', 'Button.css', 'VButton.css', 'ButtonGroup.css', 'IconButton.css', 'Tab.css', 'ToolIcons.css', 'Select.css', 'Combobox.css', 'Checkbox.css', 'Toggle.css', 'TextInput.css', 'NumberInput.css', 'FieldLabel.css', 'Tooltip.css', 'PanelStudyName.css', 'PanelButton.css', 'Spinner.css', 'PanelSectionTitle.css', 'PanelGroup.css', 'Avatar.css', 'Chip.css', 'StudyStatus.css', 'StudyRow.css', 'StudyTableHeader.css', 'DropdownMenu.css', 'StudyContent.css', 'ScrollableContent.css', 'Stepper.css', 'Slider.css'];
    ...
    const compositeCssFiles = ['Modal.css', 'AppHeader.css', 'ProductBanner.css', 'HomePageActionBar.css', 'PanelHeader.css', 'LeftPanel.css', 'StudyStatusBar.css', 'Accordion.css', 'Workspace.css', 'ToolTile.css', 'Calendar.css', 'AircraftSelector.css', 'EmptyState.css', 'ChartCard.css', 'TimePicker.css', 'DateTimePicker.css', 'StepperGroup.css'];
