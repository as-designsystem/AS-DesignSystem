# Codex AI Instructions for AS Design System

This file contains instructions for Codex AI (or any AI assistant) to properly implement new components, composites, and templates in the AS Design System.
